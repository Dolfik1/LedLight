// Библиотека для управления RGB-лентой на светодиодах типа ws281x.
...
void SmartLED::setOption(char* option, char* strVal)
{
    ...
    switch (controlMode)
    {
        case MIWaves:
            ...
            } else if (strcmp(option, "colorSpeed") == 0)
            {
                settings.waves.speed = parseSignedValue(strVal);
            } else if (strcmp(option, "wavesCount") == 0)
            {
        ...
        case MIRainbow:
            ...
            } else if (strcmp(option, "count") == 0)
            {
                ...
                (this->*effect)(true);
            } else if (strcmp(option, "revRainbow") == 0)
            {
        ...
        case MILines:
            ...
            } else if (strcmp(option, "mcLines") == 0)
            {
                settings.lines.multiColor = parseSingleValue(strVal);
            } else if (strcmp(option, "revLines") == 0)
            {
        ...
        case MISnowflake:
            ...
            } else if (strcmp(option, "mcSnowflake") == 0)
            {
        ...
        case MIStroboscope:
            ...
            } else if (strcmp(option, "mcStroboscope") == 0)
            {
...
//        break;
        case MISnake:
            ...
            } else if (strcmp(option, "mcSnake") == 0)
            {
                settings.snake.multiColor = parseSingleValue(strVal);
                (this->*effect)(true);
            } else if (strcmp(option, "revSnake") == 0)
            {
